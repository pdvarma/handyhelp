...
public class LoginHelper extends AppCompatActivity implements RestConstants {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle("Login Helper");
        dialog = new ProgressDialog(LoginHelper.this);
...
//        IP=sharedPreferences.getString("ip","");
        ...
        String url = SITE1+IP+SITE2+ LOGIN_HELPER;
    ...
    private void process(JSONObject object) {
        try {
            ...
            toast("login helper_id : " + userid + " : " + user_name);
            editor.putString("helper_id", userid);
            editor.apply();
            String a=sharedPreferences.getString("helper_id","");
            Log.d("SP", a);
            Intent i1=new Intent(LoginHelper.this,LocationTrackerService.class);
            startService(i1);
            Intent intent = new Intent(LoginHelper.this,HelperMainPage.class);
