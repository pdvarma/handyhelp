...
import com.handyhelp.handlyhelp.users.BookedListingAdapter;
...
public class HelperMainPage extends AppCompatActivity implements RestConstants{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.helper_main_page);
        setTitle("Booked Appointments");
        dialog = new ProgressDialog(HelperMainPage.this);
        ...
        getHelperListing(sharedPreferences.getString("helper_id",""));
    ...
    private void getHelperListing(String user_id) {
        ...
        String url = SITE1+IP+SITE2+ BOOKED_APPOINTMENT_HELPERS;
