...
public final class userBookedAppListing_jsp extends org.apache.jasper.runtime.HttpJspBase
...
PreparedStatement statement = connection.prepareStatement("SELECT user_id,helper_id,service_id,date,payment_status FROM appointments ");
...
//            main.put("appointments",array);	
        ...
        PreparedStatement statement2 = connection.prepareStatement("SELECT helper_id,full_name,email,contact FROM helpers WHERE helper_id='"+result.getString("helper_id")+"'");
...
//            main.put("appointments",array);	
    ...
    //            object.put("status", "success");
                ...
                newobject3.put("full_name", result1.getString("full_name"));
